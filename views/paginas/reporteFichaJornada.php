                    ...
                    <div class="row">
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <div class="section-content">
                                ...
                                <p><strong>EMA Parroquial:</strong> <?= $nombres_apellidos_idma ?> 0<?= $telefono_idma ?></p>
                                <p><strong>Secretaría de Alimentación de la Alcaldía de Caracas:</strong> <?= $nombres_apellidos_idsa ?> 0<?= $telefono_idsa ?></p>
                                <p><strong>Vocero(a):</strong> <?= $nombres_apellidos_id_vocero ?> 0<?= $telefono_id_vocero ?></p>
                                <p><strong>Datos Operador Caravana o Aliado:</strong> <?= $nombres_apellidos_id_doca ?> 0<?= $telefono_id_doca ?></p>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered table-hover ">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    <td><?= $especie                    = $datos_especies['id']; ?></td>
                                        ...
                                        <tbody>
                                            <tr class="table-success">
                                                <th id="distribuidos" colspan="5">TOTAL DE ESPECIE A DISTRIBUIR</th>
                                                <th> <?= $total_kilos ?> Kg</th>
                                                <th>
